  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          '!bg-grape-900 !text-grape-50 hover:bg-grape-900 hover:text-grape-50 focus:bg-grape-900 focus:text-grape-50 dark:bg-grape-50 dark:text-grape-900 dark:hover:bg-grape-50 dark:hover:text-grape-900 dark:focus:bg-grape-50 dark:focus:text-grape-900',
        day_today:
        ...
        day_range_middle:
          'aria-selected:!bg-grape-200 aria-selected:!text-grape-900 dark:aria-selected:bg-grape-800 dark:aria-selected:text-grape-50 aria-selected:rounded-none',
