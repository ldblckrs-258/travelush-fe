        ...
        >
          <div className='m-1 flex h-12 w-fit cursor-pointer items-center px-2'>
            ...
            <div className='flex h-full flex-col gap-1 py-2'>
              ...
              <span className='min-w-[90px] text-left text-sm font-semibold leading-4 tracking-wide text-slate-800 dark:text-kimberly-200'>
                {checkIn ? format(checkIn, 'MMM d, yyyy') : 'Select date'}
              </span>
            </div>
          </div>
          <Separator
            className='h-8 w-[1px] bg-grape-400/20 dark:bg-grape-200/20'
          ...
          <div className='m-1 flex h-12 w-fit cursor-pointer items-center px-2'>
            <div className='flex h-full flex-col gap-1 py-2'>
              ...
              <div className='min-w-[90px] text-left text-sm font-semibold leading-4 tracking-wide text-slate-800 dark:text-kimberly-200'>
